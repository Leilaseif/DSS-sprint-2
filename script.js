...
video.addEventListener("ended", () => {
    console.log("Video ended: Triggering chatbot feedback");
    ...
    const generalInput = document.getElementById("userInput"); // General chatbot input
    const generalSendButton = generalInput.nextElementSibling; // General chatbot Send button
    ...
    likeButton.addEventListener("click", () => {
        ...
        // Hide the general chatbot input field and button
        generalInput.style.display = "none";
        generalSendButton.style.display = "none";

        // Add a temporary feedback input field and button
        const feedbackInput = document.createElement("input");
        feedbackInput.type = "text";
        feedbackInput.placeholder = "Type your feedback here...";
        feedbackInput.style.width = "80%";
        feedbackInput.style.marginTop = "10px";
        feedbackInput.style.padding = "5px";
        ...
        sendFeedbackButton.textContent = "Send";
        sendFeedbackButton.style.marginLeft = "10px";
        sendFeedbackButton.style.padding = "5px 10px";
        sendFeedbackButton.style.background = "#007bff";
        sendFeedbackButton.style.color = "white";
        sendFeedbackButton.style.border = "none";
        sendFeedbackButton.style.borderRadius = "5px";
        sendFeedbackButton.style.cursor = "pointer";
        ...
        sendFeedbackButton.addEventListener("click", () => {
            ...
            if (feedback) {
                ...
                // Show the general chatbot input field and button again
                generalInput.style.display = "block";
                generalSendButton.style.display = "block";

                chatBox.scrollTop = chatBox.scrollHeight; // Scroll to the bottom
            }
        });

        chatBox.appendChild(feedbackInput);
        chatBox.appendChild(sendFeedbackButton);
        chatBox.scrollTop = chatBox.scrollHeight; // Scroll to the bottom
    });
